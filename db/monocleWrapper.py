...
class MonocleWrapper(DbWrapperBase):
    ...
    def submit_pokestops_map_proto(self, origin, map_proto):
        ...
        self.executemany(query_pokestops_insert,
                         list_of_pokestops_insert_vals, commit=True)
        self.executemany(query_pokestops_update,
                         list_of_pokestops_updates_vals, commit=True)
