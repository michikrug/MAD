            ...
            try:
                ...
                for section in update_order:
                    ...
                    for elem_id, elem in config_file[section]['entries'].items():
                        ...
                        if not exists:
                            continue
                        logger.info('{} {} already exists and a new ID will be generated', dm_section,
                                    elem_id)
                    ...
                    for key, elem in copy.deepcopy(config_file[section]['entries']).items():
                        ...
                        if dm_section == 'area':
                            try:
                                ...
                                logger.info('Updating monivlist from {} to {}', key,
                            ...
                            for walkerarea_id in elem['setup']:
                                try:
                                    ...
                                    logger.info('Updating walker-walkerarea from {} to {}', walkerarea_id,
                                                new_list[-1])
                                except KeyError:
